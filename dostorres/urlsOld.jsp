        ...
        <tr>
            <td>
                <table align=center border=0 width="100%">
                            ...
                            <table class="clsTableTitle" width="100%" cellSpacing="0" cellPadding="0" align=center border="0">
                                <tbody>
                                	<tr>
                                        ...
                                        <td class="td_title_bc" height="21" width="50%">
                                            <%=rb.getString("urls.myLinks")%>
                                        </td>
                                        <td class="td_title_bc" height="21"  width="25%">
                                            &nbsp;
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    <tr>
                        <td width="5%" class="td_titulo_C barraBlue">
                    ...
                    <logic:iterate id="link" name="userURLs" indexId="ind" offset="<%=bean.getDesde()%>" length="<%=bean.getCuantos()%>"
                        ...
                        <tr>
                            ...
                            <td class='td_<%=num%>'>
                                <%--<a class="ahref_b" href="<%=link.getUrl()%>" target="_blank">--%>
                                    <%--<%=link.getUrl()%>--%>
                                <!--</a>-->
                                <%
