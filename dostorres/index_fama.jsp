...
<style>
.tableInic {
	background-image: url(img/fondo_fama.jpg);
		...
		<tr>
			<td width="25%" height="130">
		        <table width="165" align=center border="0">
		            <tr>
		                <td align="left" class="txt" style="color:brown;">
			...
			<td width="75%" align="center">
				<table border="0" align="center" cellspacing="1" cellpadding="0" >
				  <tr>
				    <td class="txtNormal" width="80" style="color:brown;"><%=rb.getString("sch.version")%>:</td>
				    <td class="txtSmall" style="color:black;">&nbsp;<%=rb.getString("lic.version")%></td>
				  </tr>
				  <tr>
				    <td class="txtNormal" styleClass="classText" style="color:brown;"><%=rb.getString("lic.propietario0")%></td>
				    <td class="txtSmall" style="color:black;">&nbsp;<%=com.desige.webDocuments.utils.ToolsHTML.getLicenceOwner()%></td>
				  </tr>
				  <tr>
				    <td class="txtNormal" style="color:brown;"><%=rb.getString("lic.licencia0")%></td>
				    <%--<td class="txtSmall">&nbsp;<%=Encryptor.usuarios%>&nbsp;&nbsp;<%=rb.getString("lic.licencia1")%></td> --%>
				    <td class="txtSmall" style="color:black;">&nbsp;<%=HandlerDBUser.getNumeroDeUsuarios()%>&nbsp;&nbsp;<%=rb.getString("lic.licencia1")%>
				  ...
				  <tr>
				    <td class="txtNormal" styleClass="classText" style="color:brown;"><%=rb.getString("lic.tipo0")%></td>
				    <td class="txtSmall" style="color:black;">&nbsp;<%=rb.getString("lic.tipo1")%></td>
				  </tr>
				  <tr>
				    <td  class="txtNormal" styleClass="classText" style="color:brown;">&nbsp;</td>
				    <td class="txtSmall"  style="color:black;">&nbsp;<%=rb.getString("lic.caduca")%><%=rb.getString("lic.caduca1")%></td>
				  </tr>
				</table>
			</td>
		</tr>
