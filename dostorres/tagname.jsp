...
function showNorms(idNorms) {
  ...
  function botones(forma) {
    ...
    function cancelar(form){
       ...
       // location.href = "loadTagnameConf.do";
          location.href="LoadArchivoPlanoTagname.do";
       }
    function cancelar2(){
   ...
   function validateRadio() {
    ...
    function validar(forma){
        if (forma.tagname.value.length==0) {
            return false;
        }
        return true;
    }
...
<table cellSpacing=0 cellPadding=2 align=center border=0 width="100%">
    <logic:present name="dataTable" scope="session">
        ...
        <html:form action='<%=(String)session.getAttribute("loadEditManager")%>'>
            <html:hidden property="idtagname2" value=""/>
            <html:hidden property="id" value=""/>
            <html:hidden property="tagname" value=""/>
                    ...
                    <table cellSpacing=0 cellPadding=0 align=center border=0 width="100%">
                        ...
                        <tr>
                           <td width="25%" class="td_titulo_C">
                                  <%=rb.getString("scpintouch.tipotagg")%>
                            </td>
                        ...
                        type="com.desige.webDocuments.utils.beans.Search" scope="session">
                            ...
                            <tr>
                                <td class='td_<%=num%>'>
                                 ...
                                 <td class='td_<%=num%>'>
                                    <div align="center">
                                        <logic:equal name="bean" property="aditionalInfo" value="1">
                                             <%=rb.getString("scpintouch.habiltado")%>
                                        </logic:equal>
                                        <logic:notEqual name="bean" property="aditionalInfo" value="1">
                ...
                <center>
                    <html:form action='<%=(String)session.getAttribute("newManager")%>'>
                        ...
                        <input type="button" class="boton" value="<%=rb.getString("btn.cancel")%>" onClick="javascript:cancelar2();" />
                          &nbsp;
                          &nbsp;
                        <input type="button" class="boton" value="<%=rb.getString("scpintouch.archplano")%>" onClick="javascript:cargarArchivoPlano();" />
                  </html:form>
                </center>
            </td>
        </tr>
        ...
        %>
                <tr>
                    <td align="center">
                        ...
                        <form name="formPagingPage" method="post" action="tagname.jsp">
                ...
                <table align=center border=0 width="100%">
                    ...
                    <tr>
                        ...
                        <td width="*" class="td_gris_l">
                             <html:text property="tagname" size="40"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <bean:define id="data" name="editTypeDoc" scope="session" type="com.focus.wonderware.intocuh_sacop.forms.Tagname"/>
                        <td>
                             <%=ToolsHTML.showCheckBox("activeI","updateCheck(this.form.activeI,this.form.active)",
                                                       String.valueOf(data.getActive()),"1")%>
