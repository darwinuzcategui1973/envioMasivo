                        ...
                        <tbody>
                            <tr>
                                <td class="td_title_bc" height="21">
                                      Impresión, Solicitud de Cambio o Eliminación
                                </td>
                            </tr>
                        </tbody>
                    </table>
              ...
              <td class="td_gris_l">
                <logic:present name="datossolicitante" scope="session">
                   <bean:define id ="solicitaprint" name="datossolicitante" type="com.desige.webDocuments.users.forms.LoginUser" scope="session"/>
                    <b><%=rb.getString("imp.requeridoPor")%>:</b> <bean:write name="solicitaprint" property="cargo"/>
                    <br><br>Destinatarios (Sólo Impresión Controlada) 
                </logic:present>
              </td>
           </tr>
                                 ...
                                 <form name="solicitudimpresion" action ="loadsolicitudImpresion.do">
							           ...
							           <tr>
							                ...
							                <span style="cursor: hand;" onclick='toggleDiv("comentario"); if(comentario.style.display == "none"){ commentsImg.src="menu-images/mas.gif";} else { commentsImg.src="menu-images/menos.gif";}'>
							                    ...
							                    <%=rb.getString("imp.agregarComentarios")%>
							                </span>
							                </td>
							           </tr>
                                       ...
                                       <tr>
                                              <td align= "center">
                                                        <%=ToolsHTML.getRadioButton("perfil",0,0,"javascript:disparandoSeleccion('0');")%> Impresión Controlada
                                              </td>
                                               <td align= "center">
                                                        <%=ToolsHTML.getRadioButton("perfil",0,1,"javascript:disparandoSeleccion('1');")%> Impresión No Controlada
                                               </td>
                                       </tr>
                                       <tr>
                                              <td align= "center">
                                                        <%=ToolsHTML.getRadioButton("perfil",0,1,"javascript:disparandoSeleccion('1');")%> Solicitud  de  Cambio
                                              </td>
 
                                               <td align= "center">
                                                        <%=ToolsHTML.getRadioButton("perfil",0,1,"javascript:disparandoSeleccion('1');")%> Solicitud de Eliminación
                                               </td>
                                       </tr>
