...
<body class="bodyInternas">
    <form name="rollBack" action="<%=request.getParameter("nexPage")%>">
        ...
        <table align=center border=0 width="100%">
            ...
            <tr>
                <td colspan="4" heigth="22" class="titleCenter" style="background: url(img/BgComments.png); background-repeat: no-repeat" valign="middle">
...
<%--            <html:textarea property="mensaje" style="display:none" />--%>
            ...
            <tr>
                <td colspan="2" align="center">
                    <input type="button" class="boton" value="<%=rb.getString("btn.ok")%>" onClick="javascript:send(this.form);" />
                    &nbsp;
