 ...
 * 
 */
public class ListUserAction extends SuperAction {
	private static Logger log = LoggerFactory.getLogger(ListUserAction.class.getName());
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			request.setAttribute("listUser",HandlerDBUser.getListUsers());
			request.setAttribute("listArea",HandlerDBUser.getListArea());
