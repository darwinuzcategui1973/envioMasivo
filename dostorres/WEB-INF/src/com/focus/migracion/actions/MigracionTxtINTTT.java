			...
			principal: while ((filaActual = bf.readLine())!=null) {
				try{
					...
					if (carpetaDestino == null || carpetaDestino.trim().length() == 0) {
						mal.println(format.format(new Date()) + "|" + (numeroFilaActual + 1) + "|" + numero + "|La carpeta destino es inválida");
						mal.flush();
						continue principal;
					}
					...
					if (verMayor == null || verMayor.trim().equals("")) {
						mal.println(format.format(new Date()) + "|" + (numeroFilaActual + 1) + "|" + numero + "|La versión mayor no es válida");
						mal.flush();
						continue principal;
					}
					...
					if (verMenor == null || verMenor.trim().equals("")) {
						mal.println(format.format(new Date()) + "|" + (numeroFilaActual + 1) + "|" + numero + "|La versión menor no es válida");
						mal.flush();
						continue principal;
					}
					...
					if(ToolsHTML.isEmptyOrNull(nombre)){
						//ERROR
						mal.println(format.format(new Date()) + "|" + (numeroFilaActual + 1) + "| Nombre del documento está vacío o no es válido");
						mal.flush();
						continue principal;
					}
					if(ToolsHTML.isEmptyOrNull(carpetaDestino)){
						//ERROR
						mal.println(format.format(new Date()) + "|" + (numeroFilaActual + 1) + "| Carpeta Destino está vacía o no es válida");
						mal.flush();
						continue principal;
					}
					if(ToolsHTML.isEmptyOrNull(carpetaActual)){
						//ERROR
						mal.println(format.format(new Date()) + "|" + (numeroFilaActual + 1) + "| Carpeta Actual está vacía o no es válida");
						mal.flush();
						continue principal;
					}
					if(ToolsHTML.isEmptyOrNull(propietario)){
						//ERROR
						//mal.println(format.format(new Date()) + "|" + (numeroFilaActual + 1) + "| Propietario está vacío o no es válido");
						//mal.flush();
						//continue principal;
						propietario = "admin";
					}
					if(ToolsHTML.isEmptyOrNull(tipoDocumento)){
						//ERROR
						mal.println(format.format(new Date()) + "|" + (numeroFilaActual + 1) + "| Tipo de Documento está vacío o no es válido");
						mal.flush();
						continue principal;
					}
					if(ToolsHTML.isEmptyOrNull(nombreFisico)){
						//ERROR
						mal.println(format.format(new Date()) + "|" + (numeroFilaActual + 1) + "| Nombre Físico está vacío o no es válido");
						mal.flush();
						continue principal;
					}
					if(ToolsHTML.isEmptyOrNull(status)){
						//ERROR
						mal.println(format.format(new Date()) + "|" + (numeroFilaActual + 1) + "| Status está vacío o no es válido");
						mal.flush();
						continue principal;
					}
					...
					if(status!=null && status.equals("A")){
						if(ToolsHTML.isEmptyOrNull(publicado) || esPublico==null && !"0".equals(esPublico)){
							//ERROR
							mal.println(format.format(new Date()) + "|" + (numeroFilaActual + 1) + "| Fecha de aprobación requerida si está en status Aprobado");
							mal.flush();
							continue principal;
						}
					}
					...
					/*if(esPublico!=null && "0".equals(esPublico) && status!=null && status.equals("A")){
						...
						if(!ToolsHTML.isEmptyOrNull(publicado) && !ToolsHTML.isEmptyOrNull(creado) &&
							...
							//ERROR
							mal.println(format.format(new Date()) + "|" + (numeroFilaActual + 1) + "| Fecha de aprobación inválida, no puede ser menor o igual a la fecha de creacion");
							mal.flush();
							continue principal;
						}
						...
						if(!ToolsHTML.isEmptyOrNull(publicado) && !ToolsHTML.isEmptyOrNull(vencimiento) &&
							...
							//ERROR
							mal.println(format.format(new Date()) + "|" + (numeroFilaActual + 1) + "| Fecha de aprobación inválida, no puede ser mayor o igual a la fecha de vencimiento");
							mal.flush();
							continue principal;
						}
						if(!ToolsHTML.isEmptyOrNull(vencimiento) && !ToolsHTML.isEmptyOrNull(dateSystem) &&
							...
							//ERROR
							mal.println(format.format(new Date()) + "|" + (numeroFilaActual + 1) + "| Fecha de vencimiento inválida, no puede ser menor o igual a la fecha actual");
							mal.flush();
							continue principal;
						}
					}*/
					...
					if ((numero == null || numero.trim().length() == 0) && (status!=null && "A".equals(status))) {
						//ERROR
						mal.println(format.format(new Date()) + "|" + (numeroFilaActual + 1) +  "| El número está vacío");
						mal.flush();
						continue principal;
					}
	                    ...
	                    if (localidad!=null) {
	                    	if (localidad.getCheckborradorCorrelativo() == Constants.permission){
	                    		...
	                    		if(status!=null && status.equals("B") && (numero == null || numero.trim().length() == 0)){
	                    			//ERROR
	            					mal.println(format.format(new Date()) + "|" + (numeroFilaActual + 1) +  "| El número está vacío. Es Borrador pero la Localidad puede requerir correlativo");
	            					mal.flush();
	            					continue principal;
	                    		}
	                    	}
