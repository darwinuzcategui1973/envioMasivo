...
@XmlRootElement(name = "obtenerDocumentosBloqueadosResponse", namespace = "http://ws.documentos.server.ondemand.qwds.focus.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "obtenerDocumentosBloqueadosResponse", namespace = "http://ws.documentos.server.ondemand.qwds.focus.com/")
public class ObtenerDocumentosBloqueadosResponse {
