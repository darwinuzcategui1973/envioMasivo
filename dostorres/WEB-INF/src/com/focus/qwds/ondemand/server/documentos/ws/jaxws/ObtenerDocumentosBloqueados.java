...
@XmlRootElement(name = "obtenerDocumentosBloqueados", namespace = "http://ws.documentos.server.ondemand.qwds.focus.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "obtenerDocumentosBloqueados", namespace = "http://ws.documentos.server.ondemand.qwds.focus.com/")
public class ObtenerDocumentosBloqueados {
