...
import com.gestionEnvio.custon.dostorres.bean.PdfReciboRequest;
import com.google.gson.Gson;


public class CreateReciboPdfAjaxAction  {
}
/*
//	static Logger log = LoggerFactory.getLogger(CreateReciboPdfAjaxAction.class.getName());
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		String message = "";
		try {
			log.info("Begin CreateReciboPdfAjaxAction...");
			...
			//Gson gson = new Gson();
			//PdfReciboRequest pdfData = gson.fromJson(data, PdfReciboRequest.class);
...
//                        String numberDoc = String.valueOf(IDDBFactorySql.getNextID("numDocs"));
            ...
            boolean result = HandlerDocuments.publicDocumentEraser(forma.getNumberGen(),"Registro proveniente de Sacop", dateParameter, HandlerProcesosSacop.getDateFirstAccion(oPlanillaSacop1TO.getIdRecibo()) );
