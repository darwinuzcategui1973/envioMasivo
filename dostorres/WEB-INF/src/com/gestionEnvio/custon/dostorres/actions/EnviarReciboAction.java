...
//		Users usuario = getUserSession();
		...
		String botonWhastsapp2 = getParameter("botonWhastsapp2") != null ? getParameter("botonWhastsapp2") : ""; // boton
																													// Whatsapp
		//// Luis Cisneros
		...
		if ("0".equalsIgnoreCase(aviso)) {
			System.out.println("*****ef de aviso 0***");
			aviso = null;
		}
		...
		if ("2".equalsIgnoreCase(botonWhastsapp2)) {
			...
			HandlerDBRecibos.mandarWhatsAppDarwin(aviso, codigo, local, nombre, unNombre, unLocal, emisionFrom,
					emisionTo, periodo, 1);
		} else {
			System.out.println("enviar mail");
			HandlerDBRecibos.mandarMailsDarwin(aviso, codigo, local, nombre, unNombre, unLocal, emisionFrom, emisionTo,
					periodo, 1);
		}
		// 00000001927
		// public static void mandarMailsDarwin(String avisoPRM, String codcliPRM,
		// String localPRM,String nombrePRM,String unNombrePRM,String unLocalPRM,String
		// emisionFromPRM,String emisionToPRM,String periodoPRM) {
		System.out.println(
				"******aqui los parametros-- putAtributte(\"unNombre\",unNombre);----------*************************");
