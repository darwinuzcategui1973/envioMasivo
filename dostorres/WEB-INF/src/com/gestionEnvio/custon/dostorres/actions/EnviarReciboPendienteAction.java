...
public class EnviarReciboPendienteAction extends SuperAction {
	private static final Logger log = LoggerFactory.getLogger(EnviarReciboPendienteAction.class);
...
super.init(mapping,form,request,response);
		...
		log.info("Se va a ejecutar el envio Recibos Pendiente-");
		
		//luego modifico el mosulo actico darwinuzcategui
...
//		Users usuario = getUserSession();
  ...
  //      String accion = getParameter("accion")!=null?getParameter("accion"):""; //boton buscar
      ...
      ////Luis Cisneros
        ...
        System.out.println("**********parametros-----*Pendiente***************************");
        ...
        if ("0".equalsIgnoreCase(aviso)){
           ...
           if ("2".equalsIgnoreCase(botonWhastsapp2)) {
        	...
        	HandlerDBRecibos.mandarWhatsAppDarwin(aviso, codigo, local, nombre, unNombre, unLocal, emisionFrom, emisionTo, periodo,2); 
        } else {
        	System.out.println("enviar mail" );
        	HandlerDBRecibos.mandarMailsDarwin(aviso, codigo, local, nombre, unNombre, unLocal, emisionFrom, emisionTo, periodo,2); 
        }
        //00000001927
