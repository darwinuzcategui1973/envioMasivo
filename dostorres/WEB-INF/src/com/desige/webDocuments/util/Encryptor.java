...
public class Encryptor {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.print("Indique la fecha de caducidad  año yyyymmdd mes 00 es enero 11 es diciembre: ");
			System.out.flush();
			fechaCaduca = entrada.readLine();
			int fechaCaducan = Integer.parseInt(fechaCaduca);
			...
			System.out.println("License II caduca Date = " + encrypt(key,fechaCaduca.toString()));
