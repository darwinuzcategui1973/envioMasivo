 ...
 *         </ul>
 */
public class FilesViewAction extends SuperAction {
	private static Logger log = LoggerFactory.getLogger(FilesViewAction.class.getName());
	...
	public synchronized ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			// eliminamos variables de session no necesarias
