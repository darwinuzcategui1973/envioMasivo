...
/**
 * Title: EditSecurityUserFilesAction.java <br/> Copyright: (c) 2004 Focus
 * Consulting C.A.<br/>
 * 
 ...
 *          </ul>
 */
public class EditSecurityUserFilesAction extends SuperAction {
	static Logger log = LoggerFactory.getLogger(EditSecurityUserFilesAction.class);
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			statu = HandlerDocuments.updateSecurityFilesUser(forma, true);
