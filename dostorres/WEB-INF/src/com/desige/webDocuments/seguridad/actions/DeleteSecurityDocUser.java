...
/**
 * Created by IntelliJ IDEA. User: srodriguez Date: 11/08/2005 Time: 05:13:17 PM
 * To change this template use File | Settings | File Templates.
 */
public class DeleteSecurityDocUser extends SuperAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm form,
		...
		try {
			...
			// " user:"+forma.getIdPerson());
			forma.setIdDocument(idDocument);

			boolean statu = HandlerDBUser.deleteSecurityDocUser(forma);
			return goSucces();
			/*
			 * if (statu) { ActionForward toOk =
