...
/**
 * Title: ShowDataRecibo.java<br>
 * @author Darwin Uzcategui
 * @version version1.0
 * <br>
 */
public class ShowDataRecibo extends SuperAction {
    private static final Logger log = LoggerFactory.getLogger(ShowDataRecibo.class);
	...
	public synchronized ActionForward execute(ActionMapping mapping,
        ...
        try {
            ...
            if(getSessionObject(Constants.MODULO_ACTIVO)!=null && getSessionObject(Constants.MODULO_ACTIVO).equals(Constants.MODULO_AVISO)) {
            ...
            if (vengoDeBuscar!=null && (("searchDocument.jsp?expand=false".equalsIgnoreCase(vengoDeBuscar)) || ("recibos.jsp".equalsIgnoreCase(vengoDeBuscar)) || vengoDeBuscar.startsWith("searchFiles.jsp"))) {
                if (perm!=null){
                    if (!"1".equalsIgnoreCase(String.valueOf(perm.getToViewDocs()))&&(!isAdmon)) {
                        putObjectSession("error",getMessage("sch.notDocsView"));
                        if (vengoDeBuscar.startsWith("recibos.jsp")){
