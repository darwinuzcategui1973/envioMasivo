 ...
 * </ul>
 */
public class PublicDocumentAction extends SuperAction {
    public ActionForward execute(ActionMapping mapping,
        ...
        try {
            ...
            //boolean result = HandlerDocuments.undoCheckOutDoc(idDocument,usuario.getUser(),idCheckOut,comments);
            boolean result = HandlerDocuments.publicDocumentEraser(idDocument,comments);
            if (result) {
