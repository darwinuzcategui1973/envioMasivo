 ...
 * To change this template use File | Settings | File Templates.
 */
public class LoadTitulosPlanillasSacopAction extends SuperAction {
    static Logger log = LoggerFactory.getLogger(LoadTitulosPlanillasSacopAction.class.getName());
    public ActionForward execute(ActionMapping actionMapping,
        ...
        try {
            ...
            putObjectSession("dataTable",titulosplanillassacop);
            putObjectSession("sizeParam",String.valueOf(titulosplanillassacop.size()));
            putObjectSession("editManager","/editPtitleSacop.do");
            putObjectSession("newManager","/newTitulosPlanillasSacop.do");
            putObjectSession("loadManager","LoadTitulosPlanillasSacop.do");
            putObjectSession("loadEditManager","/loadTitulosPlanillasSacopEdit.do");
            putObjectSession("formEdit","editPtitleSacop");
