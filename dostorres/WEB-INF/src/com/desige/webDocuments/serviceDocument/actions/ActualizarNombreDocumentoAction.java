...
public class ActualizarNombreDocumentoAction  extends Action { 
	...
	public synchronized ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			//vemos luego loque le mandamos
			servicioDocumento.actualizarNombreDocumento( docReq.getExtension(), docReq.getIdCheckOut());
