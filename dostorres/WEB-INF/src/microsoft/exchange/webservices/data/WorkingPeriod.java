...
final class WorkingPeriod extends ComplexProperty {
	...
	protected boolean tryReadElementFromXml(EwsServiceXmlReader reader)
		...
		if (reader.getLocalName().equals(XmlElementNames.DayOfWeek)) {
			...
			this.startTime = Long.parseLong(String.valueOf(reader.readElementValue(Integer.class)));
			return true;
		} else if (reader.getLocalName().equals(
				XmlElementNames.EndTimeInMinutes)) {
			this.endTime = Long.parseLong(String.valueOf(reader.readElementValue(Integer.class)));
			return true;
		} else {
			return false;
		}
