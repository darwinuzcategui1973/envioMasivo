...
function showNorms(idNorms) {
  ...
  function botones(forma) {
    ...
    function validar(forma){
    	forma.area.value = forma.area.value.trim();
        if (forma.area.value.length==0) {
            return false;
        }
        return true;
    }
...
<table cellSpacing=0 cellPadding=2 align=center border=0 width="100%">
    <logic:present name="dataTable" scope="session">
        ...
        <html:form action='<%=(String)session.getAttribute("loadEditManager")%>'>
            ...
            <html:hidden property="area" value=""/>
            <html:hidden property="prefijo" value=""/>
        ...
        %>
                <tr>
                    <td align="center">
                        ...
                        <form name="formPagingPage" method="post" action="area.jsp">
                ...
                <table align=center border=0 width="100%">
                    ...
                    <tr>
                        ...
                        <td width="*" class="td_gris_l">
                             <html:text property="area" size="40"/>
                        </td>
                    </tr>
                    <tr>
                        <td width="16%" class="titleLeft" style="background: url(img/btn120.png); background-repeat: no-repeat" valign="middle">
                            <%=rb.getString("cbs.prefix")%>&nbsp;<%=rb.getString("scp.sacop")%>:
                        </td>
                        <td width="*" class="td_gris_l">
                             <html:text property="prefijo" size="10" maxlength="5"/>
                        </td>
                    </tr>
                    <tr>
...
<script language="javascript">
	...
	if(document.frmArea1!=null && document.frmArea1.id!=null && document.frmArea1.id.value=='1' && document.getElementById("eliminar")!=null) {
