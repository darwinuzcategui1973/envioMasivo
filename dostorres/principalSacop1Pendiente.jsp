...
<script type="text/javascript">
	function showPlanilla(forma,id,edo){
        ...
        if ((edo=='<%=LoadSacop.edoBorrador%>')) {    //edoBorrador
             ...
             window.parent.parent.info.document.getElementById("printSacopBtn").style.display = "none";
    ...
    function visualizarTodos(){
    	alert("visualizarTodo darwinuzcategui principalSacop1pendiente.jsp");
	...
	<table cellSpacing="0" cellPadding="0" align="center" border="0" width="100%">
		...
		<logic:present name="pendientes" scope="session"> 
			...
			<logic:iterate id="pendientes1" name="pendientes" type="com.desige.webDocuments.sacop.forms.Plantilla1BD" scope="session" >
                <tr id="tr<%=pendientes1.getIdplanillasacop1()%>" class='fondo_<%=(cont==0?cont++:cont--)%>'> 
					<td id="LIN_A<%=++indice%>" >
				   ...
				   <td id="LIN_B<%=indice%>" class="txt_b">
				   		<%=pendientes1.getFechaemision()!=null?ToolsHTML.getSdfShowWithoutHour(pendientes1.getFechaemision()):""%>
				   </td>
				  ...
				  <td id="LIN_F<%=indice%>" class="txt_b">
				  	<%=pendientes1.getTitulosplanillas()==null?"No definida":pendientes1.getTitulosplanillas()%>
				  </td>
				 ...
				 <td id="LIN_G<%=indice%>" class="txt_b">
				  ...
				  <td id="LIN_J<%=indice%>" class="txt_b">&nbsp;
						  <%=pendientes1.getNumberTrackingSacop()!=null?pendientes1.getNumberTrackingSacop():""%>
					</td>
