 ...
 */
	...
	var nameNavigator = sayswho();
	if(nameNavigator!=null){
		ie = nameNavigator.substring(0,2) == 'IE';
	}
    ...
    */
	...
	if (dom)
	{
		...
		document.write ("<div  onclick='bShow=true' id='calendar'	style='z-index:+999;position:absolute;visibility:hidden;left:0px;top:0px;'><table width="+((showWeekNumber==1)?220:190)+" style='font-family:arial;font-size:11px;border-width:1;border-style:solid;border-color:#a0a0a0;font-family:arial; font-size:11px}' bgcolor='#ffffff'><tr bgcolor='#0000aa'><td><table width='"+((showWeekNumber==1)?218:188)+"'><tr><td style='padding:2px;font-family:arial; font-size:11px;'><font color='#ffffff'><B><span id='caption'></span></B></font></td><td align=right><a href='javascript:hideCalendar(false)'><IMG SRC='"+imgDir+"close.gif' WIDTH='15' HEIGHT='13' BORDER='0' ALT='Close the Calendar'></a></td></tr></table></td></tr><tr><td style='padding:5px' bgcolor=#ffffff><span id='content'></span></td></tr>")
   ...
   function WeekNbr(n) {
	...
	function popUpCalendar(ctl,	ctl2, day, month, year, format, listHolidays, contenedor, postCalendar) {
		...
		if (!bPageLoaded) { 
			alert("Cargando la pagina... presione para ver el calendario");
		}
