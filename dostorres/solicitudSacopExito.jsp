...
<!--/**
 * Title: solicitudSacopExito.jsp<br>
...
<html>
	...
	<body class="bodyInternas" >
		<center class="titleCenter" style="color:#2f2f2f">
			<h1><%=rb.getString("requestSacop.msgExito1")%></h1>
			<h3><%=rb.getString("requestSacop.msgExito2")%></h3>
