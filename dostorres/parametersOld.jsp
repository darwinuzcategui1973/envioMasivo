                 ...
                 <%--   <tr>
                    ...
                    <table class="clsTableTitle" width="110" cellSpacing=0 cellPadding=0 align=center border=0>
                        <tbody>
                            <tr>
                                <td class="td_title_bc" height="21">
                                    <%=rb.getString("param.mailSetting")%>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <tr>
                        ...
                        <td>
                            <html:text property="domain" size="30" maxlength="250" styleClass="classText"/>
                        </td>
                    </tr>
	                <tr>
                        <td colspan="2"></td>
                    ...
                    <tr>
                        <td class="titleLeft" height="26" style="background: url(img/btn260.gif); background-repeat: no-repeat" valign="middle">
                            <%=rb.getString("param.ldapUrl")%>:
                        </td>
                        <td>
                            <html:text property="ldapUrl" size="30" maxlength="250" styleClass="classText"/> Ej. ldap://servidor:389
                        </td>
                    </tr>
	                <tr>
                        <td colspan="2"></td>
                    ...
                    <tr>
                        <td class="titleLeft" height="26" style="background: url(img/btn260x60.gif); background-repeat: no-repeat" valign="middle">
