                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" border="0" cellspacing="0" class="borderWindowPrincipal">
                            <tr>
                                <td class="td_titulo_C" width="6%">
                                    <%=rb.getString("doc.Ver")%>
                                </td>
                                <td class="td_titulo_C" width="50%">
                                    <%=rb.getString("doc.name")%>
                                </td>
                                <td class="td_titulo_C" width="10%">
                                    <%=rb.getString("doc.type")%>
                                </td>
                                <td class="td_titulo_C" width="20%">
                                    <%=rb.getString("doc.dateWFExpired")%>
                                </td>
                                <td class="td_titulo_C" width="14%">
                                    <%=rb.getString("label.expiredTo")%>
                                </td>
                            </tr>
                        </table>
                    </td>
