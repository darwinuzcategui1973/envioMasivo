                    ...
                    <table cellSpacing="3" cellPadding="3" align=center border=0 width="100%">
                        ...
                        type="com.desige.webDocuments.utils.beans.Search" scope="session">
                            ...
                            <tr>
                                ...
                                <td class='td_<%=num%>'>
		                                <%=com.desige.webDocuments.utils.ToolsHTML.getRegisterClassActionRecommended(bean.getAditionalInfo())%>
                                </td>
                            </tr>
                        </logic:iterate>
                   </table>
        ...
        %>
                <tr>
                    <td align="center">
                        ...
                        <form name="formPagingPage" method="post" action="accionRecomendada.jsp">
