...
<tr>
	<td align="right">
	   <input type="button" id="btnAnterior" value="Anterior" onclick="anterior()" style="width:100px;" disabled="disabled" />
	   &nbsp;&nbsp;
	   <input type="button" id="btnSiguiente" value="Siguiente" onclick="siguiente()" style="width:100px;"/>
	   &nbsp;&nbsp;
	   <span id="botones">
	   <input type="button" id="btnEmitir" value="Emitir" onclick="emitir()" style="width:100px;" disabled="disabled" />
	   &nbsp;&nbsp;
	   <input type="button" id="btnGuardar" value="Guardar" onclick="guardar()" style="width:100px;" disabled="disabled" />
		&nbsp;&nbsp;
		</span>
