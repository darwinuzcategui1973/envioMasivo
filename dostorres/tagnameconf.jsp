  ...
  function botones(forma) {
   ...
   function validateRadio() {
    ...
    function validar(forma){
        if (forma.tipotag.value.length==0) {
            return false;
        }
        return true;
    }
    ...
    // function cargar(){
      // loadSacops('0','exec','sacoplantilla','sacop_relacionadas',0);
   // }
...
<table cellSpacing=0 cellPadding=2 align=center border=0 width="100%">
    <logic:present name="dataTable" scope="session">
        ...
        <html:form action='<%=(String)session.getAttribute("loadEditManager")%>'>
            <html:hidden property="idtagname" value=""/>
            <html:hidden property="id" value=""/>
            <html:hidden property="tipotag" value=""/>
            <html:hidden property="tipoalarma" value="" />
            <html:hidden property="valor" value="" />
                ...
                <td>
                    <table cellSpacing=0 cellPadding=0 align=center border=0 width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="td_title_bc" height="21">
                                                  <%=rb.getString("scpintouch.tipotag")%>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <tr>
                            ...
                            <td width="33%" class="td_titulo_C">
                                 <%=rb.getString("scpintouch.tipotagg")%>
                            </td>
                            <td width="33%" class="td_titulo_C">
                                  <%=rb.getString("scpintouch.tipoalarma")%>
                            </td>
                            <td width="33%" class="td_titulo_C">
                                 <%=rb.getString("scpintouch.valor")%>
                            </td>
        ...
        %>
                <tr>
                    <td align="center">
                        ...
                        <form name="formPagingPage" method="post" action="tagnameconf.jsp">
                ...
                <table align=center border=0 width="100%">
                    ...
                    <tr>
                        ...
                        <td width="*" class="td_gris_l">
                             <html:text property="tipotag" size="40"/>
                        </td>
                    </tr>
                     <tr>
                        <td width="16%" class="titleLeft" style="background: url(img/btn120.png); background-repeat: no-repeat" valign="middle">
                        ...
                        <td width="*" class="td_gris_l">
                             <html:text property="tipoalarma" size="40"/>
                        </td>
                    </tr>
                     <tr>
                        <td width="16%" class="titleLeft" style="background: url(img/btn120.png); background-repeat: no-repeat" valign="middle">
                        ...
                        <td width="*" class="td_gris_l">
                             <html:text property="valor" size="40"/>
                        </td>
                    </tr>
                    <tr>
