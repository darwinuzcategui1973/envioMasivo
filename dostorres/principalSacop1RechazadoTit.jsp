<!-- principalSacop1RechazadoTit.jsp -->
                    ...
                    <td>
                            ...
                            <tbody>
                                <tr>
                                    <td class="td_title_bc" height="15">
	                                      <%=rb.getString("scp.sacop")%>&nbsp;<%=rb.getString("scp.rechazados")%>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table width="100%"  cellSpacing="0" cellPadding="0" border="0">
              		        <tr>
					            ...
					            <td class="td_titulo_C borderLeft" width="20%">
					            ...
					            <td class="td_titulo_C borderLeft">
									&nbsp;
					            </td>
					            <td class="td_titulo_C borderLeft">
									&nbsp;
