<!--/**
 * Title: noconformidadesRefFrame.jsp <br>
...
<%
    ...
    valueReturn = valueReturn.replaceAll("opener.document","window.parent.document");
    ...
    String buscar1=request.getAttribute("buscar1")!=null?(String)request.getAttribute("buscar1"):"";
    if (ToolsHTML.isEmptyOrNull(buscar1)) {
    	buscar1 = "";
    }
    String idRout=request.getAttribute("idRout")!=null?(String)request.getAttribute("idRout"):"";
    if (ToolsHTML.isEmptyOrNull(idRout)) {
    	idRout = "";
    }
    String nameRout=request.getAttribute("nameRout")!=null?(String)request.getAttribute("nameRout"):"";
...
<script type="text/javascript">
    ...
    function setValue(id){
        <%=inputReturn%>
		window.parent.saveNoConformidades(id);
    }
...
<body class="bodyInternas" <%=onLoad%> style="margin:0px;">
        ...
        %>
        <form name="associate" method="post" action="saveSacop_loadNoconformidadesRefFrame.do">
            ...
            <input type="hidden" name="buscar1" value="<%=buscar1%>">
            <input type="hidden" name="idRout" value="<%=idRout%>">
            <input type="hidden" name="nameRout" value="<%=nameRout%>">
        </form>
           ...
           <logic:notEqual name="relacionarBusqueda" scope="request" value="-1">
            ...
            <tr>
               <td>
                ...
                <td>
                    <input type="text" name="buscar1" value="<%=request.getAttribute("buscar1")!=null?request.getAttribute("buscar1"):""%>" onkeypress="javascript:checkKey(event,document.search);" />
               </td>
                <td>
            ...
            <form name="formPagingPage" method="post" action="loadNoconformidadesRef.do">
