<!--**
 * Title: recordFiltersMain.jsp <br/>
...
<script type="text/javascript">
    ...
    function validar(forma) {
        ...
        if (forma.hasta.value.length != 0 ){
			...
			var	yearNow	 = today.getYear()<1900?(1900+today.getYear()):today.getYear();
...
<!--Filtros areas / cargos-->
   	<table width="100%" height="90%" cellSpacing=0 cellPadding="0" align=center border="0">
      	<tr>
         	<td align="center">
         		<fieldset>
					                					...
					                					<table class="td_title_bc" cellspacing="0" cellpadding="0" border="0">
					                						<tr>
					                							...
					                							<td>&nbsp;
					           									...
					           									<td>&nbsp;
								            						<input type="button" name="btnDateFrom" onclick="showCalendar(this.form.desde,'calendario1');" value='>>' class="boton" style="width:20px;"></input>
					           									</td>
					           									<td>&nbsp;
					                					...
					                					<table class="td_title_bc" cellspacing="0" cellpadding="0" border="0">
					                						<tr>
					                							...
					                							<td>&nbsp;
					           									...
					           									<td>&nbsp;
								                            		<input type="button" name="btnDateTo" onclick="showCalendar(this.form.hasta,'calendario2')" value='>>' class="boton" style="width:20px;"></input>
					           									</td>
					           									<td>&nbsp;
