                ...
                <tr>
                    <td>
                            ...
                            <tbody>
                                <tr>
                                    <td class="td_title_bc" height="15">
	                                      <%=rb.getString("scp.sacop")%>&nbsp;<%=rb.getString("scp.emitido")%>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        <table width="100%"  cellSpacing="0" cellPadding="0" border="0">
              		        <tr>
                                <td class="td_titulo_C" width="19%">
                                    <%=rb.getString("scp.num")%>
                                </td>
                                <td class="td_titulo_C borderLeft" width="24%">
                                ...
                                <td class="td_titulo_C borderLeft" width="6%">
									&nbsp;
                                </td>
                                <td class="td_titulo_C borderLeft" width="1%">
									&nbsp;
                                </td>
                              </tr>
                        </table>
