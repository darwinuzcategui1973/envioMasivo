...
<script type="text/javascript" >
    ...
    function deleteSecurity(idGroup,idUser) {
       ...
       // alert("forma.idDocument.value="+forma.idDocument.value);
        if (idDocument!=null && idDocument!='null' && idDocument.length>0 ){
            forma.action = "deleteSecDocGroup.do";
        }else{
            forma.action = "deletePermission.do";
        }
...
<body class="bodyInternas" <%=onLoad%>>
    <!-- Formulario para Obtener el nodo Seleccionado por el usuario -->
            <html:form action="/loadSecurityGroups.do">
   ...
   <!-- SIMON 09 JUNIO 2005 FIN -->
    <table border="0" width="100%">
        <tr>
            <td class="pagesTitle" style="font-size:20">
                    ...
                    <tbody>
                        <tr>
                            <td class="td_title_bc" height="21">
                                <%=rb.getString("seguridad.groupWithOutSec")%>
                     ...
                     <!-- SIMON 09 JUNIO 2005 FIN-->
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                ...
                                <form name="formPaginaGrupo" method="post" action="allGroups.jsp">
                                            ...
                                            <tr>
                                                <td colspan="2" align="center">
							                        ...
							                        <table class="paginador">
                                                        ...
                                                        <form name="formPaginaGrupo1" method="post" action="allGroups.jsp">
                                                            <input type="hidden" name="from"  value="">
                                                            <input type="hidden" name="cmd"  value="<%=SuperActionForm.cmdLoad%>">
                                                        </form>
                                                </td>
