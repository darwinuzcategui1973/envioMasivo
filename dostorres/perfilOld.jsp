...
<table cellSpacing="0" cellPadding="2" align="center" border="0" width="100%">
  <tr>
    <td width="86%" valign="top">
        <html:form action="editPerfil">
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="3">
                ...
                <tr>
                    <td class="titleLeft" style="background: url(img/btn120.png); background-repeat: no-repeat" width="15%" height="26" valign="middle">
                ...
                <tr>
                    <td class="titleLeft" style="background: url(img/btn120.png); background-repeat: no-repeat" height="22px">
   ...
   <%--             <logic:present name="primeravez" scope="session">
                 <logic:equal name="primeravez" value="true">--%>
                     <tr>
