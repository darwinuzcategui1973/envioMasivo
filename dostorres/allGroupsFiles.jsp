...
<%
    ...
    String txt = "";
    txt = rb.getString("files.security.toFiles");
...
<script type="text/javascript">
    ...
    function deleteSecurity(idGroup,idUser) {
        ...
        forma.action = "deleteSecFilesGroup.do";
        forma.submit();
    }
...
<body class="bodyInternas" <%=onLoad%>>
    <!-- Formulario para Obtener el nodo Seleccionado por el usuario -->
            <html:form action="/loadSecurityGroupsFiles.do">
                     ...
                     <!-- SIMON 09 JUNIO 2005 FIN-->
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                ...
                                <form name="formPaginaGrupo" method="post" action="allGroupsFiles.jsp">
                                            ...
                                            <tr>
                                                <td colspan="2" align="center">
							                        ...
							                        <table class="paginador">
                                                        ...
                                                        <form name="formPaginaGrupo1" method="post" action="allGroupsFiles.jsp">
                                                            <input type="hidden" name="from"  value="">
                                                            <input type="hidden" name="cmd"  value="<%=SuperActionForm.cmdLoad%>">
                                                        </form>
                                                </td>
