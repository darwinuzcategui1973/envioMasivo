                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" border="0" cellspacing="0" class="borderWindowPrincipal">
                            <tr>
                                <td class="td_titulo_C" width="7%" colspan="2"><%=rb.getString("doc.Ver")%></td>
                                <td class="td_titulo_C" width="67%"><%=rb.getString("doc.name")%></td>
                                <td class="td_titulo_C" width="26%"><%=rb.getString("doc.dateDocExp")%></td>
                            </tr>
                        </table>
                    </td>
                </tr>
