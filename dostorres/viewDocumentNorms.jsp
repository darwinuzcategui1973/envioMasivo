...
<%
    ...
    String file = "showFileNorms.jsp" + parameters;
...
%>
    <link rel=alternate media=print href="<%=com.desige.webDocuments.utils.ToolsHTML.getFolderTmp()%>/<%=nameFileToPrint%>">
<%}%>
</head>
