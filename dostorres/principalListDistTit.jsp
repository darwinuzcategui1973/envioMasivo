                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" border="0" cellspacing="0" class="borderWindowPrincipal">
                            <tr>
                                <td class="td_titulo_C" width="5%"><%=rb.getString("doc.Ver")%></td>
                                <td class="td_titulo_C" width="73%"><%=rb.getString("doc.name")%></td>
                                <td class="td_titulo_C" width="23%"><%=rb.getString("doc.number")%></td>
                            </tr>
                        </table>
                    </td>
                </tr>
