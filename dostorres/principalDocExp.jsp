                                ...
                                <logic:iterate id="docExp" name="docExpires" type="com.desige.webDocuments.document.forms.DocumentsCheckOutsBean" scope="session" >
                                    <%
                                        if (PerfilAdministrador.userIsInAdminGroup(usuario)
                                        		&& !previousValue.equals(docExp.getPersonBean().getIdPerson())) {
                                            previousValue = docExp.getPersonBean().getIdPerson();
                                    %>
                                    <tr class='fondo_header'>
                                    <td colspan="4">
                                        <span class="txt_b">
                                            &nbsp;
                                            <b><%= docExp.getPersonBean().getApellido() + ", " + docExp.getPersonBean().getNombre() %></b>
                                            &nbsp;
                                    ...
                                    <tr class='fondo_<%=cont==0?cont++:cont--%>'>
                                        ...
                                        <td class="txt_b" width="73%" >
                                            <a href="javascript:showDocument('<%=docExp.getIdDocument()%>')" target="info" class="ahref_b">
