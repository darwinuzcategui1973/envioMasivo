<!--/**
 * Title: recibosPendientes.jsp <br>
...
<script language="JavaScript">
    ...
    function enviarEmailDarwin(frm,action) {
        ...
        frm.action = action;//"EnviarReciboPendiente.do";
        frm.action = "EnviarReciboPendiente.do";
        frm.submit();
    }
...
//        var hWnd = null;
    ...
    function ordenar(orderBy) {
        ...
        forma.action = "orderReciboPendiente.do";
...
<body class="bodyInternas" <%=onLoad%>>
	<table cellSpacing="1" cellPadding="0" align="center" border="0"
		...
		<form name="search" method="post" action="showRecibosPendiente.do" id="search">
					...
					<table cellSpacing="0" cellPadding="2" border="0"
							...
							<td height="30px" class="ppalBoton"
								...
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td class="ppalTextBold" width="100%">&nbsp;<%=rb.getString("enl.docPublic")+" Pendiente"%>
										</td>

										<td><span><img src="icons/buscar32.svg"
												title="<%=rb.getString("btn.search")%>"
												onClick="javascript:searchItem(document.search,'showRecibosPendiente.do',1);"></span>&nbsp;
										</td>
										...
										<td><span><img src="icons/whatsapp32.svg"
												...
												onClick="javascript:enviarWhastAppDarwin('EnviarReciboPendiente.do','2',document.search);"></span>&nbsp;
											<!--  	onClick="javascript:enviarWhastAppDarwin(document.search,'EnviarRecibo.do','1','55');"></span>&nbsp;-->
										</td>
										<%}%>
										<td><span><img src="icons/email32a.svg"
												title="<%=rb.getString("btn.email")%>"
												onClick="javascript:enviarEmailDarwin(document.search,'EnviarReciboPendiente.do');"></span>&nbsp;</td>
										<td class="none">
						...
						<tr>
							<td height="99%" bgcolor="white" valign="top"
								...
								<form name="Selection" id="Selection" action="EnviarReciboPendiente.do">
									<input type="hidden" name="botonWhatsapp21" value="1" /> <input
										...
										type="hidden" name="from" value="recibosPendientes.jsp" />
								</form>
							</td>
						</tr>
								...
								<table class="clsTableTitle" width="100%" cellSpacing="0"
									...
									<tbody>
										<tr>
											...
											<td class="td_title_bc" height="19" width="40%"><%=rb.getString("pb.title")+" Pendientes"%>
											</td>
											<td class="td_title_bc" height="19" width="30%"><logic:present
													name="size" scope="session">
													<span class="tituloSuave2"> (<%=rb.getString("sch.totalDoc") + " " + session.getAttribute("size") + " " + rb.getString("cbs.documents")+" Pendientes"%>)
													</span>
												</logic:present> &nbsp;</td>
										</tr>
									</tbody>
