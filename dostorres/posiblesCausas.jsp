...
function showNorms(idNorms) {
  ...
  function botones(forma) {
    ...
    function edit(num){
        ...
        forma.idPossibleCause.value=num;
        forma.id.value = num;
    ...
    function validar(forma){
    	forma.descPossibleCause.value = forma.descPossibleCause.value.trim();
        if (forma.descPossibleCause.value.length==0) {
            return false;
        }
        return true;
    }
...
<table cellSpacing=0 cellPadding=2 align=center border=0 width="100%">
    <logic:present name="dataTable" scope="session">
        ...
        <html:form action='<%=(String)session.getAttribute("loadEditManager")%>'>
            <html:hidden property="idPossibleCause" value=""/>
            <html:hidden property="id" value=""/>
            <html:hidden property="descPossibleCause" value=""/>
        ...
        %>
                <tr>
                    <td align="center">
                        ...
                        <form name="formPagingPage" method="post" action="posiblesCausas.jsp">
                ...
                <table align=center border=0 width="100%">
                    ...
                    <tr>
                        ...
                        <td width="*" class="td_gris_l">
                             <html:text property="descPossibleCause" size="40"/>
                        </td>
                    </tr>
                    <tr> 
...
<script language="javascript">
	...
	if(document.frmPossibleCause1!=null && document.frmPossibleCause1.id!=null && document.frmPossibleCause1.id.value=='1' && document.getElementById("eliminar")!=null) {
