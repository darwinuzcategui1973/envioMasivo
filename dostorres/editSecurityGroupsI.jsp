<!--/**
 * Title: editSecurityGroupsI.jsp <br/>
 
 * Copyright: (c) 2004 Focus Consulting C.A.<br/>
 * @author Ing. Roger Rodr�guez
 * @author Ing. Simon Rodr�guez (SR)
 * @version WebDocuments v3.0
 * <br/>
 * Changes:<br/>
 * <ul>
 *      <li>19/05/2005 se valido por revision o aprobacion  (SR)</li>
...
<%
    ...
    if(!ToolsHTML.showFlujo()){
    	session.removeAttribute("completeFTP");
    }
%>
<html>
<head>
...
<script language="JavaScript">
    ...
    function ChequearTodos(chkbox) {
             ...
             var nombre=document.forms[0].elements[i];
                // alert("nombre:"+nombre.name+" letra:" + nombre.name.charAt(nombre.name.lastIndexOf('I')));
...
<body class="bodyInternas" <%=onLoad!=null?onLoad.toString():""%>>
               
<html:form action="/updateSecurityGroup.do">
    <logic:present name="securityUser" scope="session">
        ...
        <table align=center border=0 width="90%">
            <tr>
                <td>
                    <table align=center border="0" width="100%" >
                        ...
                        <tr>
                            <td width="22%" class="titleLeft" style="background: url(img/btn120.png); background-repeat: no-repeat" height="26" valign="middle">
                        ...
                        <logic:equal value="<%=Constants.cmdToStruct%>" name="securityUser" property="command">
                                ...
                                <td class="titleLeft" style="background: url(img/btn120.png); background-repeat: no-repeat" valign="middle" height="26">
                                 ...
                                 <td class="td_gris_l">
                                  ...
                                  <td class="td_gris_l">
                                   ...
                                   <%} else {%>
                                   		<td>&nbsp;</td>
                                   		<td><html:hidden property="toDoFlows" /></td>
                                   <%}%>
                              </tr>
                            ...
                            <logic:notEqual value="<%=Constants.cmdToStruct%>" name="securityUser" property="command">
                                <tr>
                                    ...
                                    <td class="td_gris_l">
                                        <logic:equal value="1" name="securityUser" property="toEdit" >
                                            <%=ToolsHTML.showCheckBox("toEditI","updateCheck(this.form.toEditI,this.form.toEdit)","1","1")%> AAA
                                        </logic:equal>
                                        <logic:notEqual value="1" name="securityUser" property="toEdit" >
                                            <%=ToolsHTML.showCheckBox("toEditI","updateCheck(this.form.toEditI,this.form.toEdit)","0","1")%> BBB
                                        </logic:notEqual>
                                        <html:hidden property="toEdit" />
                                    </td>
		                            <td width="22%" class="titleLeft" style="background: url(img/btn120.png); background-repeat: no-repeat" height="26" valign="middle">
                        ...
                        <logic:notEqual value="<%=Constants.cmdToStruct%>" name="securityUser" property="command" >
                            <tr>
                                ...
                                <td width="22%" class="titleLeft" style="background: url(img/btn120.png); background-repeat: no-repeat" valign="middle" height="26">
                            ...
                            <tr>
                              ...
                              <tr style="display:<%=ToolsHTML.showFlujo()?"":"none"%>;">
                                <td class="titleLeft" style="background: url(img/btn120.png); background-repeat: no-repeat" valign="middle" height="26">
            ...
            <logic:equal value="<%=Constants.cmdToStruct%>" name="securityUser" property="command" >
                        ...
                        <table align=center border=0 width="100%">
                            ...
                            <tr>
                                <td colspan="4" align="left" class="txt_title">
                                    <span style="cursor: hand;" onclick='toggleDiv("documents"); if(documents.style.display == "none"){ commentsImg.src="menu-images/mas.gif";} else { commentsImg.src="menu-images/menos.gif";}'>
                ...
                <tr>
                    <td>
                        <div class="clsMessageView" id='documents'>
                            <table align=center border=0 width="100%">
                                <tr>
                                    <td width="24%">
                                    </td>
                                ...
                                <tr>
                                    <!-- Crear Flujos de Trabajo Param�tricos -->
                                    <td class="titleLeft" style="background: url(img/btn120.png); background-repeat: no-repeat" valign="middle" height="26">
                                        <%=rb.getString("seguridad.toFlexFlow")%>:
                                    </td>
                                    <td class="td_gris_l">
                                        <logic:equal value="1" name="securityUser" property="toFlexFlow" >
                                            <%=ToolsHTML.showCheckBox("toFlexFlowI","updateCheck(this.form.toFlexFlowI,this.form.toFlexFlow)","1","1")%>
                                        </logic:equal>
                                        <logic:notEqual value="1" name="securityUser" property="toFlexFlow" >
                                            <%=ToolsHTML.showCheckBox("toFlexFlowI","updateCheck(this.form.toFlexFlowI,this.form.toFlexFlow)","0","1")%>
                                        </logic:notEqual>
                                        <html:hidden property="toFlexFlow"/>
                                    </td>
                                    <td class="titleLeft" style="background: url(img/btn120.png); background-repeat: no-repeat" valign="middle" height="26">
                                        <%=rb.getString("security.toChangeUsr")%>:
                                    </td>
                                    <td class="td_gris_l">
                                        <%=ToolsHTML.showCheckBox("toChangeUsrI","updateCheck(this.form.toChangeUsrI,this.form.toChangeUsr)",(sec.getToChangeUsr()==1?"1":"0"),"1")%>
                                        <html:hidden property="toChangeUsr"/>
                                    </td>
                                </tr>
                                <%}%>
                                <tr>
                                    <!-- Crear Flujos de Trabajo Param�tricos -->
									<logic:present name="completeFTP">
									<logic:equal name="completeFTP" value="true">
	                                    <!-- Completar flujos no terminados -->
	                                    <td class="titleLeft" style="background: url(img/btn120.png); background-repeat: no-repeat" valign="middle" height="26">
	                                        <%=rb.getString("seguridad.toCompleteFlow")%>:
	                                    </td>
	                                    <td class="td_gris_l">
	                                        <logic:equal value="1" name="securityUser" property="toCompleteFlow" >
	                                            <%=ToolsHTML.showCheckBox("toCompleteFlowI","updateCheck(this.form.toCompleteFlowI,this.form.toCompleteFlow)","1","1")%>
	                                        </logic:equal>
	                                        <logic:notEqual value="1" name="securityUser" property="toCompleteFlow" >
	                                            <%=ToolsHTML.showCheckBox("toCompleteFlowI","updateCheck(this.form.toCompleteFlowI,this.form.toCompleteFlow)","0","1")%>
	                                        </logic:notEqual>
	                                        <html:hidden property="toCompleteFlow"/>
	                                    </td>
	                                </logic:equal>
									<logic:notEqual name="completeFTP" value="true">
	                                    <td class="titleLeft" valign="middle" height="26">
	                                        &nbsp;
	                                    </td>
	                                    <td class="td_gris_l">
	                                        &nbsp;
	                                ...
	                                <td class="titleLeft" style="background: url(img/btn120.png); background-repeat: no-repeat" valign="middle" height="26">
	                                    <%=rb.getString("security.toPublicEraser")%>:
	                                </td>
	                                <td class="td_gris_l">
	                                    <%=ToolsHTML.showCheckBox("toPublicEraserI","updateCheck(this.form.toPublicEraserI,this.form.toPublicEraser)",(sec.getToPublicEraser()==1?"1":"0"),"1")%>
	                                    <html:hidden property="toPublicEraser"/>
	                                </td>
                                </tr>
                                
                                <tr>
                                    <td class="titleLeft" style="background: url(img/btn120.png); background-repeat: no-repeat" valign="middle" height="26">
                                        <%=rb.getString("seguridad.toDownload")%>:
                                    </td>
                                    <td class="td_gris_l">
                                        <%=ToolsHTML.showCheckBox("toDownloadI","updateCheck(this.form.toDownloadI,this.form.toDownload)",(sec.getToDownload()==1?"1":"0"),"1")%>
                                        <html:hidden property="toDownload"/>
                                    </td>
            ...
            <tr>
                ...
                <tr>
                    <td colspan="4" align="center">
                        <center>
							<a id="btnOK" class="boton botonLinkBack" id="lnkEditar" name="lnkEditar"  title="Haga click en abrir cuando el navegador se lo pregunte."  onClick="javascript:sendData(this.form)" >
	                            <%=rb.getString("btn.ok")%>
							</a>
	                        &nbsp;
							<a id="btnCancel" class="boton botonLinkBack" id="lnkEditar" name="lnkEditar"  title="Haga click en abrir cuando el navegador se lo pregunte."  onClick="javascript:cancelar(this.form)" >
