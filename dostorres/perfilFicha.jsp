...
String styleTxt = "width: 250px; height: 19px";
...
<script language="JavaScript">
    ...
    function validar(forma) {
        ...
        <%if (String.valueOf(HandlerParameters.PARAMETROS.getValidateEmail()).equals("0")) {%>
        	...
        	<%if (HandlerParameters.PARAMETROS.getDomainEmail() != null
		&& !HandlerParameters.PARAMETROS.getDomainEmail().trim().equals("")) {
            ...
            if  (document.perfil.clave.value==document.perfil.clavenueva.value){
                if (document.perfil.clave.value.length >= parseInt(document.perfil.lengthPass.value)) {
                    if (validar(document.perfil)) {
                    	document.perfil.target="bandeja";
		...
		<table cellspacing="0" cellpadding="3" border="0" width="100%">
			<tr>
				<td colspan="2" width="100%">
					<table class="clsTableTitle" width="100%" cellSpacing="0"
						...
						<tbody>
							<tr>
								<td class="td_title_bc" height="21"><logic:present
										name="primeravez" scope="session">
										<%=rb.getString("enl.perfilseg")%>
									</logic:present> <logic:notPresent scope="session" name="primeravez">
			...
			<tr>
				<td width="50%">
					...
					<fieldset style="height: 240px">
						<legend class="etiqueta"><%=rb.getString("user.titulo.datos")%>&nbsp;:
						</legend>
						<br />
						...
						<table width="100%" border="0" cellspacing="3" cellpadding="3">
							<tr>
								<td class="titleLeft"
									style="background: url(img/btn120.png); background-repeat: no-repeat; width: 180px"
									height="26" valign="middle"><%=rb.getString("login.user")%>:
								</td>
								<td valign="middle"><font class="txtRigth"> <bean:write
											name="perfil" property="user" />
								</font></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td valign="middle" class="titleLeft"
									style="background: url(img/btn120.png); background-repeat: no-repeat"
									height="26"><%=rb.getString("user.ape")%>:</td>
								<td valign="top"><html:text property="apellidos"
										styleClass="classText" style="<%=styleTxt%>" /></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td class="titleLeft"
									style="background: url(img/btn120.png); background-repeat: no-repeat"
									height="26"><%=rb.getString("user.name")%>:</td>
								<td><html:text property="nombres" size="25"
										styleClass="classText" style="<%=styleTxt%>" /></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td valign="middle" class="titleLeft"
									style="background: url(img/btn120.png); background-repeat: no-repeat"
									height="26"><%=rb.getString("user.cargo")%>:</td>
								<td><html:text property="cargo" size="25" disabled="true"
										readonly="true" styleClass="classText" style="<%=styleTxt%>" />
							...
							<tr>
								<td valign="middle" class="titleLeft"
									style="background: url(img/btn120.png); background-repeat: no-repeat"
									height="26"><%=rb.getString("user.email")%>:</td>
								<td><html:text property="email" size="25"
										styleClass="classText" style="<%=styleTxt%>" /></td>
								<!-- <td class="txt_b"><%=HandlerBD.pruebaOtraBaseDatos("00000008")%> -->
								</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td class="titleLeft"
									style="background: url(img/btn120.png); background-repeat: no-repeat"
									height="23"><%=rb.getString("user.phone")%>:</td>
								<td><html:text property="telefono" size="12"
										styleClass="classText" maxlength="15"
				...
				<td width="50%" valign="top">
					<!-- ini primera columna -->
					<fieldset style="height: 240px">
						<legend class="etiqueta"><%=rb.getString("user.titulo.configuracion")%>&nbsp;:
						</legend>
						<br />
						...
						<table cellSpacing="3" cellPadding="3" align="center" border="0"
							...
							<tr>
								<td class="titleLeft"
									style="background: url(img/btn120.png); background-repeat: no-repeat; width: 180px"
									height="23"><%=rb.getString("user.languaje")%>:</td>
								<td><logic:present name="idiomas" scope="request">
										<html:select property="idioma" styleClass="classText">
											<logic:iterate id="idio" name="idiomas"
							...
							<tr>
								<td class="titleLeft"
									style="background: url(img/btn120.png); background-repeat: no-repeat"
									height="23"><%=rb.getString("user.area")%>:</td>
								<td><logic:present name="tblareas" scope="request">
										<%
										String selecArea = "";
										%>
										<select name="area" disabled size="1" style="width: 210px;"
											styleClass="classText">
											<logic:iterate id="idio" name="tblareas"
												type="com.desige.webDocuments.utils.beans.Search">
												<logic:equal name="perfil" property="area"
													value="<%=idio.getId()%>">
													<option value="<%=idio.getId()%>" selected="true"><%=idio.getDescript()%></option>
												</logic:equal>
												<logic:notEqual name="perfil" property="area"
													value="<%=idio.getId()%>">
							...
							<tr>
								<td class="titleLeft"
									style="background: url(img/btn120.png); background-repeat: no-repeat"
									height="23px"><%=rb.getString("user.numRecord")%>:</td>
								<td><html:text property="numRecordPages" size="12"
										styleClass="classText" /></td>
								<td>&nbsp;</td>
							</tr>
							<!--<tr>
					    <td class="titleLeft" style="background: url(img/btn120.png); background-repeat: no-repeat" height="23px">
					    ...
					    <td>&nbsp;</td>
							...
							<tr>
								<td height="42" class="titleLeft"
									style="background: url(img/btn120.png); background-repeat: no-repeat"
									valign="middle"><%=rb.getString("clave.nueva")%></td>
								<td><html:password property="clave" size="40"
										styleClass="classText"
										onkeypress="return isAllowedInPassword(event);" /> <html:hidden
										property="repclave" /></td>
							</tr>
							<tr>
								<td height="42" class="titleLeft"
									style="background: url(img/btn120.png); background-repeat: no-repeat"
									valign="middle"><%=rb.getString("clave.rep_nueva")%></td>
								<td><html:password property="clavenueva" size="40"
										styleClass="classText"
										onkeypress="return isAllowedInPassword(event);" /></td>
							</tr>
						</table>
			...
			<tr>
				<td width="50%" colspan="2" valign="top">
					<!-- ini primera columna -->
					<fieldset>
						<legend class="etiqueta"><%=rb.getString("user.titulo.ubicacion")%>&nbsp;:
						</legend>
							...
							<tr>
								<td width="50%">
									<table width="100%" border="0" cellspacing="3" cellpadding="3">
										<tr>
											<td class="titleLeft"
												style="background: url(img/btn120.png); background-repeat:repeat; width: 180px"
												height="30" valign="middle"><%=rb.getString("user.dir")%>:
											</td>
											<td><html:textarea property="direccion" cols="25"
													rows="4" styleClass="classText" style="width:250px" /></td>
											<td>&nbsp;</td>
										</tr>
										<tr>
											<td class="titleLeft"
												style="background: url(img/btn120.png); background-repeat: no-repeat"
												height="23"><%=rb.getString("user.ciudad")%>:</td>
											<td><html:hidden property="ciudad" /> <html:text
													property="nameCity" size="30" readonly="true"
													styleClass="classText" /> <input type="button"
												class="boton" value="..."
												onClick="javascript:editField('loadCity.do','ciudad','nameCity',this.form);"
												style="width: 20px;" /></td>
											<td>&nbsp;</td>
										</tr>
									</table>
								...
								<td>
									<table width="100%" border="0" cellspacing="3" cellpadding="3">
										<tr>
											<td class="titleLeft"
												style="background: url(img/btn120.png); background-repeat: no-repeat"
												height="22"><%=rb.getString("user.edo")%>:</td>
											<td><html:hidden property="estado" /> <html:text
													property="nameState" size="30" readonly="true"
													styleClass="classText" /> <input type="button"
												class="boton" value="..."
												onClick="javascript:editField('loadState.do','estado','nameState',this.form);"
												style="width: 20px;" /></td>
											<td>&nbsp;</td>
										</tr>
										<tr>
											<td valign="top" class="titleLeft"
												style="background: url(img/btn120.png); background-repeat: no-repeat"
												height="22px"><%=rb.getString("user.pais")%>:</td>
											<td><html:hidden property="pais" /> <html:text
													property="namePais" size="30" readonly="true"
													styleClass="classText" /> <input type="button"
												class="boton" value="..."
												onClick="javascript:editField('loadCountries.do','pais','namePais',this.form);"
												style="width: 20px;" /></td>
											<td>&nbsp;</td>
										</tr>
										<tr>
											<td class="titleLeft"
												style="background: url(img/btn120.png); background-repeat: no-repeat"
												height="23"><%=rb.getString("user.zip")%>:</td>
											<td><html:text property="zip" size="12" maxlength="10"
													styleClass="classText" /></td>
											<td>&nbsp;</td>
										</tr>
									</table>
