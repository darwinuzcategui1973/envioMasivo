...
function openLink(evt) {
	...
	window.open("principalDocReqTit.jsp","bandejaTit");
	window.open("loadDocumentRequired.do","bandeja");
}
                    ...
                    <td>
                        <table class="clsTableTitle" width="100%" cellSpacing=0 cellPadding="0" align=center border=0>
                        	<tr>
                        		<td>
									<div class="tab">
									  <button class="tablinks active" ><%=rb.getString("doc.pending")%></button>
									  <button class="tablinks" onclick="openLink(event)"><%=rb.getString("doc.pendingRequired")%></button>
									</div>
                        		</td>
                        	</tr>
                        </table>
                        ...
                        -->
                        <!-- Flujos Pendientes -titulos nombre documento -->
                        <table width="100%" border="0" cellspacing="0" class="borderWindowPrincipal">
                            <tr>
                                <td class="td_titulo_C" width="7%"><%=rb.getString("doc.number")%></td>
                                <td class="td_titulo_C" width="62%"><%=rb.getString("doc.name")%></td>
                                <td class="td_titulo_C" width="7%"><%=rb.getString("doc.Ver")%></td>
                                <td class="td_titulo_C" width="15%"><%=rb.getString("doc.dateCheckOut")+" y/o "+rb.getString("wf.dateExpire")%></td>
                                <td class="td_titulo_C" width="15%"><%=rb.getString("doc.status")%></td>
                            </tr>
                        </table>
                    </td>
                </tr>
