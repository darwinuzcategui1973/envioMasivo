...
<script type="text/javascript">
   ...
   function updateCheck(check,field) {
    ...
    function deleteSecurity(idPerson) {
...
<body class="bodyInternas" <%=onLoad%>>
    ...
    <!-- Formulario para Obtener el nodo Seleccionado por el usuario -->
            <html:form action="/loadSecurityUser.do">
                ...
                <input type="hidden" name="rout" value='<%=session.getAttribute("rout")%>'/>
                    ...
                    <tbody>
                        <tr>
                            <td class="td_title_bc" height="21">
                                <%=rb.getString("seguridad.title") + " " + txt%>
                                <bean:write name="securityUserII" property="rout"/>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table cellSpacing=0 cellPadding=0 align=center border=0 width="100%">
                   ...
                   <!-- SIMON 09 JUNIO 2005 FIN -->
                    <%
                        ...
                        String size = String.valueOf(((Collection)session.getAttribute("usuarios")).size());
                ...
                <table cellSpacing=0 cellPadding=0 align=center border=0 width="100%">
                    ...
                    indexId="ind" offset="<%=bean.getDesde()%>" length="<%=bean.getCuantos()%>">
                        ...
                        <tr>
                            ...
                            <td class='td_<%=num%>'>
                            <a class="ahref_b" href="javascript:deleteSecurity('<%=user.getIdPerson()%>')">
