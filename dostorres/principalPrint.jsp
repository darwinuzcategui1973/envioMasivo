                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" border="0" cellspacing="1" class="borderWindowPrincipal" >
                            <logic:present name="wfPrintApproved" scope="session" >
                            	<% 
                            	    int cont=0;
                            	    Integer previousValue = 0;
                            	%>
                                <logic:iterate id="docCheck" name="wfPrintApproved" type="com.desige.webDocuments.document.forms.DocumentsCheckOutsBean" scope="session" >
                                    <%
                                    ...
                                    <td colspan="3">
                                        <span class="txt_b">
                                            ...
                                            <%if(isRespsolimpres){%>
                                            	&nbsp;&nbsp;&nbsp;<%=rb.getString("cbs.responsible")%>: <b><%=respsolimpres%></b>
                                            <%}%>
                                        </span>
                                    </td>
                                    </tr>
                                    ...
                                    <tr class='fondo_<%=cont==0?cont++:cont--%>'>
                                        ...
                                        <td width="60%" id="imgImpresora<%=docCheck.getIdDocument()%>">
                                            ...
                                            <a href="#" 
											  onclick="javascript:showDocumentPrint('<%=docCheck.getIdDocument()%>','<%=docCheck.getNumVer()%>','<%=docCheck.getIdDocument()%>','5','');"
                                              class="ahref_b">
