<!-- /**
 * Title: editSecurityUsersI.jsp <br/> 
 ...
 *      <li>27/04/2006      Se agreg� cambos de Seguridad para ver Documentos </li>
                        ...
                        <div class="clsMessageView" id='documents'>
                            <table align=center border=0 width="100%">
                                ...
                                <tr>
                                    ...
                                    <td width="*" class="td_gris_l">
                                        <%=ToolsHTML.showCheckBox("toEditDocsI","updateCheck(this.form.toEditDocsI,this.form.toEditDocs)",(sec.getToEditDocs()==(byte)1?"1":"0"),"1")%>
